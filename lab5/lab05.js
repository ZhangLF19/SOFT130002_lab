...
function showWindowHref(){
    if(url.value.substring(url.value.indexOf("name="),url.value.indexOf("name=")+4)==="name")
        { url_result.value= url.value.substring(url.value.indexOf("name=")+5,url.value.indexOf("&"));}
    if(url.value.substring(url.value.indexOf("name="),url.value.indexOf("name=")+4)!=="name")
       { let i=(Math.random()*10);url_result.value=url.value.substring(i,2*i);}
}
...
function arrSameStr(){
    ...
    result.value="The most character is:" +  character + " times:" + times
